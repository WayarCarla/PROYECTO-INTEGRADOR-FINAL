...
class VENTANA(Frame):
    ...
    def fModificar (self):
        ...
        if clave == '':
            ...
            self.limpiarcajas()
            self.txtIdtipo.insert(0,valores[1])
            self.txtIdestado.insert(0,valores[2])
            self.txtIdopcom.insert(0,valores[3])
            self.txtIdprop.insert(0,valores[4])
            self.txtdir.insert(0,valores[5])
            self.txtlocalidad.insert(0,valores[6])
            self.txtprovincia.insert(0,valores[7])
            self.habilitarbtnoperaciones("disabled")
            self.habilitarbtnguardar("normal")
            self.txtIdtipo.focus()
    ...
    def create_widgets(self):
        ...
        self.btnguardar.config(font=("Arial",13,"bold"),bg="green",fg="black", width=70, bd=3)
        ...
        self.btncancelar.config(font=("Arial",13,"bold"),bg="red",fg="black", width=70, bd=3)
